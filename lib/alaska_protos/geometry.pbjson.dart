...
const Geometry$json = const {
  '1': 'Geometry',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.geometry.Geometry.Type', '10': 'type'},
    const {'1': 'coordinates', '3': 2, '4': 3, '5': 11, '6': '.geometry.Coordinate', '10': 'coordinates'},
    const {'1': 'geometries', '3': 3, '4': 3, '5': 11, '6': '.geometry.Geometry', '10': 'geometries'},
  ],
