...
line2 = LineString(((1.0, 2.0), (3.0, 4.0)))
line3 = LineString([(1.0, 2.0), (3.0, 4.0)])
line4 = LineString((Point(1.0, 2.0), (2.0, 3.0), Point(3.0, 4.0)))
line5 = LineString(((1.0, 2.0, 3.0), (3.0, 4.0, 5.0)))
ring = LinearRing([(0, 0), (1, 1), (1, 0)])
ring2 = LinearRing([(0.0, 0.0), (1.0, 0.0), (1.0, 1.0), (0.0, 0.0)])
...
geoms = [p1,p2,line1,line2,line3,line4,line5,ring2,ring,polygon]
rings = [ring2,ring,p0,line1]

multi = [points,m,lines]

serializer = ShapelyGeometrySerializer()

for geom in multi:
    serialized = serializer.serialize(geom)
    print(str(serialized)[0:30])

# serialized = serializer.serialize(polygon)
# print(serialized)