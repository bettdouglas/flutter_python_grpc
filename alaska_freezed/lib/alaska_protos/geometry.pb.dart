...
class Coordinate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Coordinate', package: const $pb.PackageName('geometry'), createEmptyInstance: create)
...
class Geometry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Geometry', package: const $pb.PackageName('geometry'), createEmptyInstance: create)
